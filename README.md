...
# Results
Please see [notebook](https://github.com/shengbo-ma/Prediction-of-Traffic-Crash-Risk-in-Chicago/blob/master/Chicago_Traffic_Crashes.ipynb). It may failed to load because of the big size. Please try refresh the webpage until it shows up.
